  ...
  button:hover {
    ...
    return(
        ...
        <Container fluid="xl" className=' d-flex flex-column align-items-center'>
          ...
          <Toaster position="top-right" expand={true}  richColors  style={{margin:'60px'}}/>
        <div className='register-tran' style={{textAlign:"center",marginTop:"100px"}}>
            ...
            <StyledWrapperbutton>
            <button id="btn"  onClick={() =>toast.success('success message')}>Register</button>
            </StyledWrapperbutton>


            <StyledWrapperbutton>
            <button id="btn" onClick={() => toast.info('This option is under development.')}  style={{marginTop:"10px"}}>Login As Admin</button>
            </StyledWrapperbutton>
